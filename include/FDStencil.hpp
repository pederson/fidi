...
// first derivative
static constexpr FDStencil1D<1>	CentralStencil_D1_O2(0.0, {{-0.5}}, {{0.5}});
static constexpr FDStencil1D<2>	CentralStencil_D1_O4(0.0, {{-2.0/3.0, 1.0/12.0}}, {{2.0/3.0, -1.0/12.0}});

// second derivative
static constexpr FDStencil1D<1>	CentralStencil_D2_O2(-2.0, {{1.0}}, {{1.0}});
static constexpr FDStencil1D<2>	CentralStencil_D2_O4(-5.0/2.0, {{4.0/3.0, -1.0/12.0}}, {{4.0/3.0, -1.0/12.0}});

// third derivative
static constexpr FDStencil1D<2>	CentralStencil_D3_O2(0.0, {{1.0, -1.0/2.0}}, {{-1.0, 1.0/2.0}});

// fourth derivative
static constexpr FDStencil1D<2>	CentralStencil_D4_O2(6.0, {{-4.0, 1.0}}, {{-4.0, 1.0}});
